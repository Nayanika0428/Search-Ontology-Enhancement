...
def fetch_disease_nodes(c):
  ...
  '''
  c.execute("select * from disease__nodes limit 10;")
  data = c.fetchall()
 ...
 '''
  Update the column in the SQL table.
    ...
    Note:
        ...
        the unique values in the 'unique_column'. It ensures data type compatibility by converting values to strings.
